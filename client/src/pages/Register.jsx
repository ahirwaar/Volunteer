          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1">
                ...
                >
                  <option value="volunteer">Volunteer for opportunities</option>
                  <option value="organization">Post volunteer opportunities</option>
                </select>
              </div>
            </div>

            {/* Organization Name field - only shown when role is organization */}
